...
-- Create cdc_capture_headers table (parent table for captures)
...
CREATE INDEX idx_cdc_capture_headers_name ON cdc_capture_headers(capture_name);

-- Create cdc_captures table (detail table for individual table captures)
...
SELECT 'Schema now includes cdc_capture_headers table' as note;